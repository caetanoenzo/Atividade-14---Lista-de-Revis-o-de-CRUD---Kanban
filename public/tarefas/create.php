...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE tarefas SET responsavel='$responsavel', descricao='$descricao', nome_setor='$nome_setor', prioridade='$prioridade', status_tarefa='$status_tarefa' WHERE id_tarefa='$id_tarefa'";
                ...
                <form action="create.php?id=<?php echo $id_tarefa; ?>" method="POST">
                        ...
                        <select name="responsavel" class="form-select" required>
                            ...
                            if ($result->num_rows > 0) {
                                while ($usuario_row = $result->fetch_assoc()) {
                                    ...
                                    echo "<option value='" . $usuario_row['responsavel'] . "' $selected>" . $usuario_row['nome'] . "</option>";
                                }
                            }
                            ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_tarefa" class="form-select" required>
                            <option value="A Fazer" <?php if ($status_tarefa == "A Fazer") echo "selected"; ?>>A Fazer</option>
                            <option value="Fazendo" <?php if ($status_tarefa == "Fazendo") echo "selected"; ?>>Fazendo</option>
                            <option value="Pronto" <?php if ($status_tarefa == "Pronto") echo "selected"; ?>>Pronto</option>
                        </select>
                    </div>
